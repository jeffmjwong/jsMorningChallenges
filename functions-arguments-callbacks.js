...
const greetAgain = (firstName='Shaun') => `hello ${firstName}!`;
console.log(greetAgain('Nic'));

// d) Create a new function called `runMe`, it should console.log `I'm running!`
const runMe = () => console.log("I'm running!");
runMe();

// e) Common interview question: What is an IIFE (pronounced "iffy")? Turn runMe into an IIFE.
const runMeAgain = (() => console.log("I'm running again!"))();
